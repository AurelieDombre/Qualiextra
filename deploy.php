...
// ---------------------------------------------------------------------------
set("env_database","mysql://Vanessa:Arcos4970@127.0.0.1:3306/qualiextra?serverVersion=mariadb-10.3.34");
// ---------------------------------------------------------------------------
...
// TODO 
set('remote_server_url','vanessa-peixoto-server.cloud');
...
// TODO branch
set('repository_target_branch', 'vanessaDeploy');
// ---------------------------------------------------------------------------
